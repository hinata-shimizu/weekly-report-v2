...
"[project]/src/components/focus/FocusTimer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FocusTimer({ initialMinutes, onComplete, onExit }) {
    _s();
    const [timeLeft, setTimeLeft] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialMinutes * 60);
    const [isRunning, setIsRunning] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [duration, setDuration] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialMinutes * 60);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FocusTimer.useEffect": ()=>{
            let interval;
            if (isRunning && timeLeft > 0) {
                interval = setInterval({
                    "FocusTimer.useEffect": ()=>{
                        setTimeLeft({
                            "FocusTimer.useEffect": (prev)=>prev - 1
                        }["FocusTimer.useEffect"]);
                    }
                }["FocusTimer.useEffect"], 1000);
            } else if (timeLeft === 0) {
                setIsRunning(false);
            ...
            return ({
                "FocusTimer.useEffect": ()=>clearInterval(interval)
            })["FocusTimer.useEffect"];
        }
    }["FocusTimer.useEffect"], [
        isRunning,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: isRunning ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                            xmlns: "http://www.w3.org/2000/svg",
                            width: "32",
                            height: "32",
                            viewBox: "0 0 24 24",
...
_s(FocusTimer, "ZUFkXYSmppMH1yi8+nQteN4xJU4=");
_c = FocusTimer;
var _c;
__turbopack_context__.k.register(_c, "FocusTimer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reportUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/reportUtils.ts [app-client] (ecmascript)"); // Assuming we need save logic imports that might not be exported yet, check utils
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$focus$2f$FocusTimer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/focus/FocusTimer.tsx [app-client] (ecmascript)");
...
function FocusPageContent() {
    ...
    const [allTasks, setAllTasks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]); // Keep all to save back
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FocusPageContent.useEffect": ()=>{
            if (!reportId || !taskId) {
                setLoaded(true);
                return;
            }
            const now = Date.now();
            const tasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reportUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadTasks"])(reportId, now);
            setAllTasks(tasks);
            const found = tasks.find({
                "FocusPageContent.useEffect.found": (t)=>t.id === taskId
            }["FocusPageContent.useEffect.found"]);
            if (found) {
                setTask(found);
            }
            setLoaded(true);
    ...
    const handleComplete = (elapsedSeconds)=>{
        ...
        if (reportId && taskId) {
            ...
            // Persist
            if ("TURBOPACK compile-time truthy", 1) {
                window.localStorage.setItem(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reportUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TASKS_KEY_PREFIX"]}${reportId}`, JSON.stringify(nextTasks));
            }
        }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$focus$2f$FocusTimer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FocusTimer"], {
                            initialMinutes: 25,
...
_s(FocusPageContent, "c6+EATxsYDwgu1SbD1jZXzk3FOI=", false, function() {
    return [
...
function FocusPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FocusPageContent, {}, void 0, false, {
            fileName: "[project]/src/app/focus/page.tsx",
            lineNumber: 138,
            columnNumber: 13
        }, this)
...
_c1 = FocusPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "FocusPageContent");
__turbopack_context__.k.register(_c1, "FocusPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_3117a6e6._.js.map